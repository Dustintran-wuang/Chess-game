...
void Board::setPiece(int row, int col, const std::string& name) {
...
void Board::promotePiece(int row, int col, const std::string& newPieceName) {
    if (row < 0 || row >= 8 || col < 0 || col >= 8) return;  // Kiểm tra giới hạn
